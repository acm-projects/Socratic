...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="fixed top-0 left-0 w-16 h-screen flex flex-col items-center justify-center gap-3 px-5 bg-[#D9E5FD]">
            <Link href = "/dashboard">
        ...
        <button className={`p-2 px-6 rounded-lg ${pathname === "/profile" ? "bg-[#F5F6FA]" : "hover:bg-gray-100"}`}>
                ...
                <button className="p-2 px-6 rounded-lg hover:bg-gray-100">
