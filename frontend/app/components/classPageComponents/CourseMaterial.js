...
export default function CourseMaterial({ files }) {
  return (
    <div>
      <h2 className="text-base font-semibold text-[#141f1d] mb-5">Course Material</h2>

      <div className="flex flex-col max-h-72 overflow-y-auto scrollbar-hide">
        {files.map((file, i) => (
          <div key={i} className="flex items-center gap-3 py-3 border-b border-[#EAEEED] last:border-none">
