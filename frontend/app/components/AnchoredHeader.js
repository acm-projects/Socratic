...
export default function AnchoredHeader({ title, showPlus }) {
  return (
    <header className="flex items-center gap-3 bg-[#D9E5FD] bg-cover bg-center rounded-md px-8 py-5 sticky top-0 z-10">
