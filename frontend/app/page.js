...
export default function Home() {
  ...
  const squares = [
    { color: "bg-blue-300", size: "w-40 h-40", top: "top-[480px]", left: "left-[100px]", rotate: "rotate-6" },
    { color: "bg-teal-200", size: "w-32 h-32", top: "top-[520px]", left: "left-[200px]", rotate: "-rotate-3" },
    { color: "bg-blue-200", size: "w-48 h-48", top: "top-[460px]", left: "left-[340px]", rotate: "rotate-2" },
    { color: "bg-indigo-200", size: "w-36 h-36", top: "top-[500px]", left: "left-[520px]", rotate: "-rotate-6" },
    { color: "bg-teal-300", size: "w-44 h-44", top: "top-[470px]", left: "left-[680px]", rotate: "rotate-4" },
    { color: "bg-blue-300", size: "w-28 h-28", top: "top-[510px]", left: "left-[840px]", rotate: "-rotate-2" },
    { color: "bg-indigo-300", size: "w-40 h-40", top: "top-[490px]", left: "left-[960px]", rotate: "rotate-8" },
    { color: "bg-teal-200", size: "w-36 h-36", top: "top-[460px]", left: "left-[50px]", rotate: "-rotate-4" },
    { color: "bg-blue-200", size: "w-32 h-32", top: "top-[530px]", left: "left-[1100px]", rotate: "rotate-3" },
  ];
  ...
  return (
    <main className="bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-start pt-32">
        ...
        {squares.map((sq, i) => (
          <div key={i} ref={el => squaresRef.current[i] = el}
      ...
      <section className="section-2 relative min-h-screen flex items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-8 z-10 max-w-2xl text-center px-8">
          ...
          <p className="text-lg text-gray-500">Our heatmaps show you exactly how much you've been studying each day.</p>
          <div className="flex flex-col gap-2 mt-4">
            <div className="flex gap-2">
              {[1,0,3,5,2].map((score, i) => (
                <div key={i} className={`w-10 h-10 rounded-md ${
                  score === 0 ? "bg-blue-100" : score <= 2 ? "bg-blue-200" :
                  score <= 3 ? "bg-blue-300" : score <= 4 ? "bg-blue-400" : "bg-blue-500"
                }`} />
              ))}
            </div>
            <div className="flex gap-2">
              {[0,2,4,5,5].map((score, i) => (
                <div key={i} className={`w-10 h-10 rounded-md ${
                  score === 0 ? "bg-blue-100" : score <= 2 ? "bg-blue-200" :
                  score <= 3 ? "bg-blue-300" : score <= 4 ? "bg-blue-400" : "bg-blue-500"
                }`} />
